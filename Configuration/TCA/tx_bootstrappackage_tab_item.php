...
return array(
    'ctrl' => array(
        ...
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        'title' => 'LLL:fileadmin/Template/Resources/Private/Language/Backend.xlf:tab_item',
        'delete' => 'deleted',
        'versioningWS' => 2,
    ...
    'palettes' => array(
        ...
        'visibility' => array(
            'showitem' => '
                hidden;LLL:fileadmin/Template/Resources/Private/Language/Backend.xlf:tab_item
            ',
            'canNotCollapse' => 1
        ),
    ),
    'columns' => array(
        'tt_content' => array(
            'exclude' => 0,
            'label' => 'LLL:fileadmin/Template/Resources/Private/Language/Backend.xlf:tab_item.tt_content',
            'config' => array(
                'type' => 'select',
        ...
        'header' => array(
            'exclude' => 0,
            'label' => 'LLL:fileadmin/Template/Resources/Private/Language/Backend.xlf:tab_item.header',
            'config' => array(
                'type' => 'input',
                'size' => 50,
                'eval' => 'trim,required'
        ...
        'bodytext' => array(
            'exclude' => 0,
            'label' => 'LLL:fileadmin/Template/Resources/Private/Language/Backend.xlf:tab_item.bodytext',
            'config' => array(
                'type' => 'text',
                'cols' => 40,
                'rows' => 3,
